...
function findEmployeeById(employeeId) {
    ...
    if (foundEmployee) {
        ...
        document.getElementById('employeesDetails').innerHTML = `<p>No employee wtih the specific ID found</p>`
    }
}
...
function findEmployeeBySpecialization(employeeSpecialization) {
    ...
    document.getElementById('employeesDetails').innerHTML = `<p>No employee wtih that specialization</p>`
   }
}